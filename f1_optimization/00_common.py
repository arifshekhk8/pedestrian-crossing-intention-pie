...
LSTM_MULTISEED = ROOT / "journal_prep" / "issue2_clean_protocol" / "runs_clean" / "multiseed"
TF_RUNS_FINAL = ROOT / "transformer" / "phase4_kaggle_final" / "runs_final"
# cached searches (val-only JSONs)
LSTM_GRID = ROOT / "journal_prep" / "issue8_grid_search" / "runs_grid"
TF_SEARCH = ROOT / "transformer" / "phase2_kaggle_search" / "runs_search"
