...
Submission copy. Refreshed 2026-08-24 to the newest primary releases; sources
are recorded in evidence/A4_statistics_refresh.md. Writes into ../figures/.
  ...
  (a) Global distribution of road traffic deaths by road user type.
      ...
      Section 1 "Fatalities by road user type". Verbatim shares. This remains
      the most recent WHO breakdown BY ROAD USER TYPE; the July 2026 WHO
      release updates the global total (1.16 million, 2025) but publishes no
      user-type split, so the total is cited in the text and not plotted here.

  (b) Pedestrian fatalities in the United States, 2015-2024.
      Source: NHTSA Traffic Safety Facts "Pedestrians: 2024 Data",
      DOT HS 813 818 (June 2026), Table 1. Verbatim counts. Note that this
      release revises 2023 from the 7,314 printed in DOT HS 813 727 to the
      FARS final-file value of 7,367.
...
# ----------------------------------------------------------------- data (b)
# NHTSA DOT HS 813 818, Table 1 (FARS). Counts of pedestrians killed.
YEARS = [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024]
PED_DEATHS = [5494, 6080, 6075, 6374, 6272, 6565, 7470, 7593, 7367, 7080]
PEAK_IDX = 7  # 2022, the maximum of the series
...
def main():
    ...
    # Selective direct labels: first, peak and last.
    for idx in (0, PEAK_IDX, len(YEARS) - 1):
        ax_b.text(
    ...
    ax_b.text(
        0, -0.28, "Down 7% from the 2022 peak, 29% above 2015;\n15% to 18% of all traffic deaths",
    ...
    out_pdf = outdir / "fig1_pedestrian_statistics.pdf"
    out_png = outdir / "fig1_pedestrian_statistics.png"
